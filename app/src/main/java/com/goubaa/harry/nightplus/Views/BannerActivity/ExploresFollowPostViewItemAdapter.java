...
public class ExploresFollowPostViewItemAdapter extends ArrayAdapter {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    typeface = Typeface.createFromAsset(context.getResources().getAssets(), "ionicons.ttf");
    ...
    CustomPicasso.with(context).load(_authorPicture).tag("radius").resize(authorPictureWidth, authorPictureWidth).centerCrop().transform(new ExploresFollowPostViewItemAdapter.RadiusTransformation(context))
      .into(authorPicture);
