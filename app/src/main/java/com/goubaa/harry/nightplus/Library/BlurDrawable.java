...
public class BlurDrawable extends ColorDrawable {
  ...
  protected boolean prepare() {
    ...
    if (mBlurringCanvas == null || mDownsampleFactorChanged || mBlurredViewWidth != width ||
      ...
      if (mBlurredBitmap == null || mBlurredBitmap.getWidth() != scaledWidth || mBlurredBitmap
      ...
      mBlurInput = Allocation.createFromBitmap(mRenderScript, mBitmapToBlur, Allocation
  ...
  private void drawBlur(Canvas canvas) {
    if (prepare()) {
      ...
      if (mBlurredBgView.getBackground() != null && mBlurredBgView.getBackground() instanceof
        ColorDrawable) {
